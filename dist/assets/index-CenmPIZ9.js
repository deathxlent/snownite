...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function ea(){return new On({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fr(),fragmentShader:`
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function na(){return new On({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fr(),fragmentShader:`
...
`].filter(ai).join(`
`)),a=wr(a),a=ua(a,e),a=da(a,e),o=wr(o),o=ua(o,e),o=da(o,e),a=fa(a),o=fa(o),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(v=`#version 300 es
